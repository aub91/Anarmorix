...
<<<<<<< HEAD
INSERT INTO `typeproduit` (`id`, `dureConservation`, `libelle`, `uniteConservation`, `id_imageDefaut`, `id_tva`, `id_categorie`) VALUES (2, NULL, 'P�t� de campagne', NULL, 1, 1, 9);
INSERT INTO `typeproduit` (`id`, `dureConservation`, `libelle`, `uniteConservation`, `id_imageDefaut`, `id_tva`, `id_categorie`) VALUES (3, NULL, 'Bi�re blonde sans gluten', NULL, 1, 1, 10);
=======
...
<<<<<<< HEAD
insert into `adherent` (`id`, `id_adresse`, `dateDesinscription`, `dateInscription`, `dateNaissance`, `id_image`, `mail`, `id_motif_desinscription`, `nom`, `password`, `prenom`, `tel1`, `tel2`, `username`, `type_adherent`, `id_relais`, `id_societe`, `id_exploitation`) values (12, 12, null, '2017-08-16 00:00:00', '2017-08-17 00:00:00', null, 'Epenth�se@autistici.org', null, 'Brassens', 'aaa', 'Eug�ne', '0666666666', null,'Keplerdelateci' , 'Client', null, null, null);
=======
