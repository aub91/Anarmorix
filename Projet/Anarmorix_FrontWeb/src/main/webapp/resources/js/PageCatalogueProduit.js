	...
	.myCart(
			{
				...
				afterAddOnCart : function(products, totalPrice,
						totalQuantity) {
					console.log("afterAddOnCart", products, totalPrice,
							totalQuantity);
				},
				clickOnCartIcon : function($cartIcon, products,
						totalPrice, totalQuantity) {
					console.log("cart icon clicked", $cartIcon,
				...
				checkoutCart : function(products, totalPrice,
					...
					console.log("checking out", products, totalPrice,
							totalQuantity);
				},
				getDiscountPrice : function(products, totalPrice,
						totalQuantity) {
					console.log("calculating discount", products,
							totalPrice, totalQuantity);
...
function incrementQty() {
	...
	$('.quantity-right-plus').click(function(e) {
		...
		// Get the field name
		quantity = parseInt($input.val());
		console.log("test qté plus" + quantity);
